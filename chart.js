...
const SERIES = {
  ...
  sbf:        {name:"SBF 120 NR (dividendes nets reinvestis)", short:"SBF 120 (indice)", color:"#5b6b85", width:2},
...
{ id:2, date:"2018-12-24", cat:"macro", title:"Correction du 4e trimestre 2018",
  ...
  move:"SBF 120 NR : -16,7 % du 01/10 au 27/12/2018", moveSign:-1,
  holdings:"Repli generalise des actions francaises.",
  body:`<p>L'automne 2018 combine le resserrement monetaire de la Reserve federale americaine, la guerre commerciale entre les Etats-Unis et la Chine et les craintes sur la croissance mondiale. Le <b>SBF 120 abandonne environ 16,7 %</b> (dividendes reinvestis) entre le 1er octobre et le point bas du 27 decembre 2018.</p><p>Sur l'annee civile 2018, le fonds recule de <b>-11,4 %</b> contre <b>-9,7 %</b> pour son indice de reference (ecart -1,7 point).</p>`,
  sources:[{l:"Calcul sur la serie officielle SBF 120 NR (donnees publiques Euronext)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2018"}] },
...
{ id:3, date:"2020-03-12", cat:"macro", title:"Krach Covid : pire seance de l'histoire du marche parisien",
  ...
  move:"SBF 120 NR : -12,3 % le 12/03/2020 ; -39,0 % du 20/02 au 18/03", moveSign:-1,
  ...
  sources:[{l:"Calcul sur l'export VL CPRAM (part I) et la serie SBF 120 NR (donnees publiques Euronext)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2020"}] },
...
{ id:4, date:"2020-11-09", cat:"macro", title:"Annonce du vaccin Pfizer-BioNTech : rebond eclair",
  ...
  move:"SBF 120 NR : pres de +20 % sur novembre 2020, mois record", moveSign:1,
  holdings:"Rotation vers les valeurs cycliques et decotees (banques, industrie, consommation).",
  body:`<p>Le <b>9 novembre 2020</b>, Pfizer et BioNTech annoncent un vaccin efficace a environ 90 % contre le Covid-19. Les marches actions s'envolent, avec une rotation massive vers les valeurs cycliques et decotees. Le <b>SBF 120 gagne pres de +20 % sur le mois de novembre 2020</b> (dividendes reinvestis), le plus fort rebond mensuel de l'histoire du marche parisien (CAC 40 : +20,1 %, record depuis sa creation en 1988).</p><p>Ce rebond ouvre la voie a l'excellente annee 2021 : <b>+29,5 %</b> pour le fonds contre <b>+28,3 %</b> pour l'indice (ecart +1,1 point).</p>`,
  sources:[{l:"Calcul sur la serie officielle SBF 120 NR (donnees publiques Euronext)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2021"}] },
...
{ id:5, date:"2022-02-24", cat:"macro", title:"Invasion de l'Ukraine : choc energie & inflation",
  ...
  move:"SBF 120 NR : -21,3 % du 05/01 au 29/09/2022 ; fonds 2022 : -11,7 % (indice -8,2 %)", moveSign:-1,
  holdings:"Les fonds excluant l'energie fossile sous-performent quand le petrole s'envole (TotalEnergies en tete du SBF 120).",
  body:`<p>Le <b>24 fevrier 2022</b>, la Russie envahit l'Ukraine. La flambee des prix de l'energie nourrit une inflation record et un resserrement monetaire brutal : le SBF 120 recule de <b>-21,3 %</b> (dividendes reinvestis) entre le 5 janvier et le point bas du 29 septembre 2022.</p><p>L'annee est particulierement difficile pour les strategies actions francaises a filtre climatique : prives de l'energie fossile (TotalEnergies, l'un des principaux contributeurs de l'indice en 2022), ces portefeuilles sous-performent mecaniquement. Le fonds termine 2022 a <b>-11,7 %</b> contre <b>-8,2 %</b> pour l'indice (ecart -3,4 points, le plus defavorable de la decennie).</p>`,
  sources:[{l:"Calcul sur la serie officielle SBF 120 NR (donnees publiques Euronext)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2022"},{l:"Recherche concurrentielle fonds climat (2026) : sensibilite des fonds climat au facteur energie"}] },
...
{ id:6, date:"2023-10-27", cat:"macro", title:"Point bas d'octobre 2023, debut du cycle haussier",
  ...
  move:"point bas du marche le 27/10/2023, puis rebond ; 2023 : fonds +20,6 % (indice +18,0 %)", moveSign:1,
  holdings:"Rebond mene par le luxe, l'industrie et les financieres.",
  body:`<p>Fin octobre 2023, le SBF 120 touche son <b>point bas de l'annee (27/10/2023)</b>, au moment ou le rendement du 10 ans americain frole les 5 %, niveau tres penalisant pour les actions.</p><p>A partir de novembre, le reflux de l'inflation et les anticipations de baisses de taux des banques centrales declenchent un puissant rebond : c'est le point de depart du cycle haussier 2023-2025. Le fonds signe une annee 2023 a <b>+20,6 %</b>, nettement au-dessus de son indice (<b>+18,0 %</b>, ecart +2,6 points), puis confirme en 2024 (+1,6 % contre -0,1 %).</p>`,
  sources:[{l:"Calcul sur la serie officielle SBF 120 NR (donnees publiques Euronext)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2023 et 2024"},{l:"Contexte de marche : pic des taux longs fin octobre 2023 et anticipations de pivot des banques centrales"}] },
...
{ id:8, date:"2025-04-07", cat:"macro", title:"Flash crash des droits de douane (« Liberation Day »)",
  ...
  sources:[{l:"Contexte de marche : droits de douane reciproques du 02/04/2025 et pause de 90 jours du 09/04/2025"},{l:"Calcul sur l'export VL CPRAM (part I) et la serie SBF 120 NR (donnees publiques Euronext)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2025"}] },
...
{ id:10, date:"2026-02-28", cat:"macro", title:"Record historique puis choc petrolier d'Ormuz",
  ...
  move:"record absolu le 26/02 (CAC 40 : 8 642 pts), puis SBF 120 NR -5,4 % du 25/02 au 05/03 ; fonds : -5,9 %", moveSign:-1,
