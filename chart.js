...
{ id:1, date:"2018-09-24", cat:"fonds", title:"Depart de l'historique de VL suivi",
  ...
  body:`<p>Le FCP a ete cree le <b>26/03/2013</b>. La courbe demarre au <b>24/09/2018</b>, premiere valeur liquidative quotidienne disponible pour la part I (FR0011354638) dans les donnees publiques.</p><p>Important pour la lecture&nbsp;: jusqu'au 30/01/2026, l'historique correspond aux <b>strategies anterieures du FCP</b> (successivement denomme «&nbsp;CPR Actions France Select&nbsp;» puis «&nbsp;CPR Actions France ESG&nbsp;»), deja investi en actions francaises avec integration ESG. Le fonds est devenu <b>CPR Actions France Climat</b> le 30/01/2026 (repere n&deg;9).</p>`,
  sources:[{l:"Pitchbook CPR Actions France Climat (avril 2026), date de creation 26/03/2013"},{l:"Donnees publiques Boursorama, part I (FR0011354638), denominations successives du FCP", u:"https://www.boursorama.com/bourse/opcvm/cours/0P0001ENBB/"}] },
...
{ id:3, date:"2020-03-12", cat:"macro", title:"Krach Covid : pire seance de l'histoire du marche parisien",
  ...
  sources:[{l:"Calcul sur les series SBF 120 et VL part I (donnees publiques Boursorama)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2020"}] },
...
{ id:8, date:"2025-04-07", cat:"macro", title:"Flash crash des droits de douane (« Liberation Day »)",
  ...
  sources:[{l:"Contexte de marche : droits de douane reciproques du 02/04/2025 et pause de 90 jours du 09/04/2025"},{l:"Calcul sur les series SBF 120 et VL part I (donnees publiques Boursorama)"},{l:"Pitchbook CPR Actions France Climat (avril 2026), performances calendaires 2025"}] },
